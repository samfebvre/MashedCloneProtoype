...
namespace PluginMaster
{
    ...
    public class BoundsOctreeNode<T>
    {
        ...
        public int BestFitChild( Vector3 objBoundsCenter ) => ( objBoundsCenter.x <= Center.x ? 0 : 1 ) + ( objBoundsCenter.y >= Center.y ? 0 : 4 ) + ( objBoundsCenter.z <= Center.z ? 0 : 2 );
        ...
        public void GetColliding( ref Ray checkRay, List<T> result, float maxDistance = float.PositiveInfinity )
        {
            ...
            if ( !bounds.IntersectRay( checkRay, out distance )
    ...
    public class BoundsOctree<T>
    {
        ...
        public Bounds GetMaxBounds() => rootNode.GetBounds();
        ...
        /// <param name="checkBounds">bounds to check.</param>
        /// <returns>True if there was a collision.</returns>
        public bool IsColliding( Bounds checkBounds ) => rootNode.IsColliding( ref checkBounds );
        ...
        /// <param name="maxDistance">distance to check.</param>
        /// <returns>True if there was a collision.</returns>
        public bool IsColliding( Ray checkRay, float maxDistance ) => rootNode.IsColliding( ref checkRay, maxDistance );
